...
class __TwigTemplate_2db9dd3390f3df3aaf2b9427ee7f05e2106e14290a7b4ba63802061bb5847d4e extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_menu_item($context, array $blocks = [])
    {
        ...
        // line 44
        echo "                ";
        $context["is_selected_submenu"] = (($context["is_selected_menu"] ?? null) && 0 !== twig_compare(((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "request", [], "any", false, true, false, 44), "query", [], "any", false, true, false, 44), "get", [0 => "submenuIndex"], "method", true, true, false, 44)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "request", [], "any", false, true, false, 44), "query", [], "any", false, true, false, 44), "get", [0 => "submenuIndex"], "method", false, false, false, 44),  -1)) : ( -1)),  -1));
        // line 45
        echo "                ";
        if ($this->extensions['EasyCorp\Bundle\EasyAdminBundle\Twig\EasyAdminTwigExtension']->isGranted(twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "permission", [], "any", false, false, false, 45))) {
            // line 46
            echo "                    <li class=\"";
            echo ((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "type", [], "any", false, false, false, 46), "divider")) ? ("header") : (""));
            echo " ";
    ...
    public function block_menu_subitem($context, array $blocks = [])
    {
        ...
        if ($this->extensions['EasyCorp\Bundle\EasyAdminBundle\Twig\EasyAdminTwigExtension']->isGranted(twig_get_attribute($this->env, $this->source, ($context["subitem"] ?? null), "permission", [], "any", false, false, false, 53))) {
            // line 54
            echo "                                        <li class=\"";
            echo ((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["subitem"] ?? null), "type", [], "any", false, false, false, 54), "divider")) ? ("header") : (""));
            echo " ";
            echo (((($context["is_selected_menu"] ?? null) && 0 === twig_compare(((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "request", [], "any", false, true, false, 54), "query", [], "any", false, true, false, 54), "get", [0 => "submenuIndex"], "method", true, true, false, 54)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "request", [], "any", false, true, false, 54), "query", [], "any", false, true, false, 54), "get", [0 => "submenuIndex"], "method", false, false, false, 54),  -1)) : ( -1)), twig_get_attribute($this->env, $this->source, ($context["subitem"] ?? null), "submenu_index", [], "any", false, false, false, 54)))) ? ("active") : (""));
            echo "\">
                                            ";
            // line 55
    ...
    public function macro_render_menu_item($__item__ = null, $__translation_domain__ = null, ...$__varargs__)
    {
        ...
        try {
            // line 2
            echo "    ";
            if (0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "type", [], "any", false, false, false, 2), "divider")) {
                // line 3
                echo "        ";
...
($context["item"] ?? null), "type", [], "any", false, false, false, 10), "empty")) ? ("#") : (""))))))));
    ...
    {
        return new Source("", "@EasyAdmin/default/menu.html.twig", "/home/ec2-user/deploy/releases/20200608195650/vendor/easycorp/easyadmin-bundle/src/Resources/views/default/menu.html.twig");
    }
}
